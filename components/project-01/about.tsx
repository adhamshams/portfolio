        ...
        <div ref={boxRef} onMouseDown={() => {
            ...
            <div className={styles.canvas}>
                <div className={styles.about}>
                    <h2>Brew Buzz Specialty Coffee – App & Website</h2>
                    <p className={styles.role}>ui/ux design, mobile dev, web dev</p>
                    <p>Brew Buzz is a specialty coffee shop with a name thats as lively as the space itself. Buzzing, bright, and irresistibly cute. From the very beginning, I wanted the digital experience to be full of personality and feel just like stepping into Brew Buzz in real life. That meant approaching the design not just as a developer, but as a storyteller translating a physical space into pixels.</p>
                    ...
                    <p>Beyond functionality, I treated the branding as an ecosystem. I secured the brewbuzzcoffee.com domain and set up a custom SMS sender ID so even OTPs felt like they came from the Brew Buzz world. The landing page, built with React.js, mirrors the in-store experience online—snappy, responsive, and SEO-optimized, with engaging visuals that introduce the shop to new customers before they even take their first sip.</p>
