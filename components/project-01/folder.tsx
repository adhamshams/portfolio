  ...
  return (
    <div>
      <div className={styles.icon} onClick={() => setVisible(true)}>
        <Image loading="eager" src={"/folder.webp"} alt="Logo" width={45} height={45} />
      ...
      {visible && (
        <div ref={boxRef} onMouseDown={() => {
          ...
          >
            <Image loading="eager" src={"/folder.webp"} alt="Logo" width={20} height={20} />
          ...
          <div className={styles.canvas}>
            ...
            >
              <Image loading="eager" src={"/txt.webp"} alt="Logo" width={45} height={45} />
              <p>about.txt</p>
            </div>
            ...
            >
              <Image loading="eager" src={"/case.webp"} alt="Logo" width={45} height={45} />
              <p>case study</p>
            </a>
            ...
            >
              <Image loading="eager" src={"/phone.webp"} alt="Logo" width={45} height={45} />
              <p>ios app</p>
            </a>
            ...
            >
              <Image loading="eager" src={"/internet.webp"} alt="Logo" width={45} height={45} />
              <p>website</p>
            </a>
          </div>
        </div>
