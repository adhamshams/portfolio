        ...
        <div ref={boxRef} className={styles.container}>
          ...
          <div className={styles.content}>
            <div className={styles.menu}>
              ...
              <p className={styles.menuItem}>Image</p>
              <p className={styles.menuItem}>Colors</p>
          ...
          <div className={styles.canvasContainer}>
            <div className={styles.toolboxGrid}>
              <div className={styles.tool} title="Free-Form Select">
                <FaRegObjectGroup color="#f4d35e" />
              </div>
              <div className={styles.tool} title="Select">
                <FaMousePointer color="#22223b" />
              </div>
              <div className={styles.tool} title="Eraser">
                <FaEraser color="#f67280" />
              </div>
              <div className={styles.tool} title="Fill With Color">
                <FaFillDrip color="#43aa8b" />
              </div>
              <div className={styles.tool} title="Pick Color">
                <FaEyeDropper color="#3a86ff" />
              </div>
              <div className={styles.tool} title="Magnifier">
                <FaSearchPlus color="#b5ead7" />
              </div>
              <div className={`${styles.tool} ${styles.active}`} title="Pencil">
                <FaPencilAlt color="#f9c74f" />
              </div>
              <div className={styles.tool} title="Brush">
                <FaPaintBrush color="#9d4edd" />
              </div>
              <div className={styles.tool} title="Airbrush">
                <FaSprayCan color="#b5838d" />
              </div>
              <div className={styles.tool} title="Text">
                <FaFont color="#22223b" />
              </div>
              <div className={styles.tool} title="Line">
                <FaSlash color="#495057" />
              </div>
              <div className={styles.tool} title="Curve">
                <FaBezierCurve color="#ffbe0b" />
              </div>
              <div className={styles.tool} title="Rectangle">
                <FaRegSquare color="#00b4d8" />
              </div>
              <div className={styles.tool} title="Ellipse">
                <FaRegCircle color="#ff006e" />
              </div>
            </div>
          ...
          <div className={styles.tip}>
            <p>
              Hello, my name is Adham Shams and this is my portfolio. Built with
              Next.js {`<`}3
            </p>
          </div>
        </div>
