    ...
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <div className={styles.metaData}>
          <Image loading="eager" src="/sun.webp" alt="sun" width={65} height={65} />
          <h2>Portfolio 01&apos;</h2>
          <p>To begin, click my user name</p>
        </div>
        <div className={styles.seperator} />
        <Link href="/desktop" className={styles.usernameContainer}>
          <Image loading="eager" src="/user.jpg" alt="user" width={65} height={65} />
          <p>Adham Shams</p>
        </Link>
      </div>
      <div className={styles.footer}>
        <div className={styles.turnOffContainer}>
          <Link href="/off">
            <Image loading="eager" src="/power.webp" alt="turn-off" width={35} height={35} />
          </Link>
